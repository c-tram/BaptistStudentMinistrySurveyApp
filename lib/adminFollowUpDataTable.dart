// ignore_for_file: use_build_context_synchronously, prefer_const_constructors, camel_case_types, library_private_types_in_public_api, use_key_in_widget_constructors, must_be_immutable, prefer_const_constructors_in_immutables, file_names
...
class adminFollowUpDataTable extends StatefulWidget {
  adminFollowUpDataTable(String username, bool isAdmin);

  @override
  _adminFollowUpDataTableState createState() => _adminFollowUpDataTableState();
}

class _adminFollowUpDataTableState extends State<adminFollowUpDataTable> {
